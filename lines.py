...
root = os.getcwd()
shields = ["CMakeFiles", "cmake-build-debug", ".idea", ".git", "glad", "KHR", "glad.c", "stb_image.h"]
lines = 0
sizes = 0
same = root
...
def help():
	print("\033[1m\033[37mLinksManifold Data Statistics Tool\033[0m")
	print("\033[1m\033[37mCopyright Link (c) 2024\033[0m")
...
def version():
	print("\033[1m\033[37mLinksManifold Data Statistics Tool \033[35mv-1.0.0\033[0m")
	print("\033[1m\033[37mCopyright Link (c) 2024\033[0m")
